"""
Django settings for getravio project.
"""
...
WSGI_APPLICATION = 'getravio.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv('DB_NAME', 'getravio'),
